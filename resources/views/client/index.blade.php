                            ...
                            <div class="tab01-head how2 how2-cl1 bocl12 flex-s-c m-r-10 m-r-0-sr991">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    @foreach($cateParent->post_catalogue_children as $cateChildren)
                                        ...
                                        @endif
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('client.category', ['id' => $cateChildren->encrypted_id, 'model' => 'children']) }}">{{ $cateChildren->post_catalogue_children_name }}</a>
                                        </li>
                                        @php $count2++; @endphp
                                    @endforeach
                                </ul>
                                ...
                                <div class="dropdown">
                                    <a class="tab01-link f1-s-1 cl9 hov-cl10 trans-03 dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-expanded="false">
                                       Xem thêm
                                    </a>
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        @foreach($cateParent->post_catalogue_children as $cateChildren)
                                        <li><a class="dropdown-item" href="{{ route('client.category', ['id' => $cateChildren->encrypted_id, 'model' => 'children']) }}">{{ $cateChildren->post_catalogue_children_name }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                                @endif
