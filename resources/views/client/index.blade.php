                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="slider-active">
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('client/img/trending/trending_top2.jpg') }}" alt="">
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('client/img/trending/trending_top02.jpg') }}" alt="">
                                        <div class="trend-top-cap">
                                            <span class="bgr" data-animation="fadeInUp" data-delay=".2s"
                                                data-duration="1000ms">Business</span>
                                            <h2><a href="latest_news.html" data-animation="fadeInUp"
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('client/img/trending/trending_top03.jpg') }}" alt="">
                                        <div class="trend-top-cap">
                                            <span class="bgr" data-animation="fadeInUp" data-delay=".2s"
                                                data-duration="1000ms">Business</span>
                                            <h2><a href="latest_news.html" data-animation="fadeInUp"
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('client/img/trending/trending_top3.jpg') }}" alt="">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('client/img/trending/trending_top4.jpg') }}" alt="">
                                        <div class="trend-top-cap trend-top-cap2">
            ...
            <div class="row">
                <div class="col-lg-8">
                                            ...
                                            <div class="col-xl-6 col-lg-12">
                                                <div class="whats-news-single mb-40 mb-40">
                                                    <div class="whates-img">
                                                        <img src="{{ asset('client/img/gallery/whats_news_details1.png') }}"
                                                            alt="">
                                                    </div>
                                            ...
                                            <div class="col-xl-6 col-lg-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                        <div class="whats-right-single mb-20">
                                                            <div class="whats-right-img">
                                                                <img src="{{ asset('client/img/gallery/whats_right_img1.png') }}"
                                                                    alt="">
                                                            </div>
                                                    ...
                                                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                        <div class="whats-right-single mb-20">
                                                            <div class="whats-right-img">
                                                                <img src="{{ asset('client/img/gallery/whats_right_img2.png') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="whats-right-cap">
                                                                <span class="colorb">FASHION</span>
                                                    ...
                                                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                        <div class="whats-right-single mb-20">
                                                            <div class="whats-right-img">
                                                                <img src="{{ asset('client/img/gallery/whats_right_img3.png') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="whats-right-cap">
                                                    ...
                                                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                        <div class="whats-right-single mb-20">
                                                            <div class="whats-right-img">
                                                                <img src="{{ asset('client/img/gallery/whats_right_img4.png') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="whats-right-cap">
                    ...
                    <div class="banner-one mt-20 mb-30">
                        <img src="{{ asset('client/img/gallery/body_card1.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-4">
                    <!-- Flow Socail -->
                    ...
                    <div class="most-recent-area">
                        ...
                        <div class="most-recent mb-40">
                            <div class="most-recent-img">
                                <img src="{{ asset('client/img/gallery/most_recent.png') }}" alt="">
                        ...
                        <div class="most-recent-single">
                            <div class="most-recent-images">
                                <img src="{{ asset('client/img/gallery/most_recent1.png') }}" alt="">
                            </div>
                        ...
                        <div class="most-recent-single">
                            <div class="most-recent-images">
                                <img src="{{ asset('client/img/gallery/most_recent2.png') }}" alt="">
                            </div>
                            <div class="most-recent-capt">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="home-banner2 d-none d-lg-block">
                            <img src="{{ asset('client/img/gallery/body_card2.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-9">
                                    ...
                                    <div class="weekly2-news-active d-flex">
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{ asset('client/img/gallery/weeklyNews1.png') }}" alt="">
                                            </div>
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{ asset('client/img/gallery/weeklyNews2.png') }}" alt="">
                                            </div>
                                            <div class="weekly2-caption">
                                                <h4><a href="#">Scarlett’s disappointment at latest
                                                        accolade</a></h4>
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{ asset('client/img/gallery/weeklyNews3.png') }}" alt="">
                                            </div>
                                            <div class="weekly2-caption">
                                                <h4><a href="#">Scarlett’s disappointment at latest
                                                        accolade</a></h4>
                    ...
                    <div class="col-12">
                        <div class="recent-active dot-style d-flex dot-style">
                            ...
                            <div class="single-recent">
                                <div class="what-img">
                                    <img src="{{ asset('client/img/gallery/tranding1.png') }}" alt="">
                                </div>
                                <div class="what-cap">
                                    <h4><a href="#">
                            ...
                            <div class="single-recent">
                                <div class="what-img">
                                    <img src="{{ asset('client/img/gallery/tranding2.png') }}" alt="">
                                </div>
                                <div class="what-cap">
                                    <h4><a href="latest_news.html">What to Expect From the 2020 Oscar Nomin
                                            ations</a></h4>
                                    ...
                                    <div class="weekly3-news-active dot-style d-flex">
                                        <div class="weekly3-single">
                                            <div class="weekly3-img">
                                                <img src="{{ asset('client/img/gallery/weekly2News1.png') }}" alt="">
                                            </div>
                                        ...
                                        <div class="weekly3-single">
                                            <div class="weekly3-img">
                                                <img src="{{ asset('client/img/gallery/weekly2News2.png') }}" alt="">
                                            </div>
                                            <div class="weekly3-caption">
                                                <h4><a href="latest_news.html">What to Expect From the 2020 Oscar
                                                        Nomin ations</a></h4>
                                        ...
                                        <div class="weekly3-single">
                                            <div class="weekly3-img">
                                                <img src="{{ asset('client/img/gallery/weekly2News3.png') }}" alt="">
                                            </div>
                                            <div class="weekly3-caption">
                                                <h4><a href="latest_news.html">What to Expect From the 2020 Oscar
                                                        Nomin ations</a></h4>
                                        ...
                                        <div class="weekly3-single">
                                            <div class="weekly3-img">
                                                <img src="{{ asset('client/img/gallery/weekly2News4.png') }}" alt="">
                                            </div>
                                            <div class="weekly3-caption">
                                                <h4><a href="latest_news.html">What to Expect From the 2020 Oscar
                                                        Nomin ations</a></h4>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-10">
                    <div class="banner-one">
                        <img src="{{ asset('client/img/gallery/body_card3.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
