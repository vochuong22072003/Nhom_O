            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>- Bạn đang muốn xóa danh mục con có tên danh mục là: <span style="color: red">{{ $postCatalogueChildren->post_catalogue_children_name }}</span></p>
                        <p>- Lưu ý <span class="text-danger">KHÔNG THỂ</span> khôi phục danh mục con sau khi xóa. <br> Hãy chắc chắn bạn muốn thực hiện chức năng này</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                        ...
                        <div class="row mb15">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    type="text"
                                    name="name"
                                    value="{{ old('name', ($postCatalogueChildren->post_catalogue_children_name)??'') }}"
                                    class="form-control"
                                    placeholder=""
                                    autocomplete="off"
                                    readonly
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    type="text"
                                    name="description"
                                    value="{{ old('description', ($postCatalogueChildren->post_catalogue_children_description)??'') }}"
                                    class="form-control"
                                    placeholder=""
                                    autocomplete="off"
                                    readonly
